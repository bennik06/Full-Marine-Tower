...
namespace marinetower
{
    ...
    class Main : BloonsMod
    {
        ...
        public class Top5 : ModUpgrade<Marinetower>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                foreach (var weaponModel in towerModel.GetWeapons())
                {
                    ...
                    weaponModel.projectile.AddBehavior(new DamageModifierForTagModel("Ddt", "Ddt", 1, 90, false, true));
                    weaponModel.projectile.AddBehavior(new DamageModifierForTagModel("Bad", "Bad", 1, 740, false, true));
        ...
        public class Middle3 : ModUpgrade<Marinetower>
        {
            ...
            public override string Description => "Captain teaches nearby monkeys to shoot twice as fast.";
            public override int Cost => 20000;
            public override int Path => MIDDLE;
            public override int Tier => 3;
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                var buff = new RateSupportModel("RateSupport", 0.5f, true, "Marine:Rate", false, 1, null, null, null);
        ...
        public class Middle4 : ModUpgrade<Marinetower>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                support[0].weapons[0].projectile.AddBehavior(new CreateTowerModel("CreateTowerInAbility", GetTowerModel<ApacheDartship>(), 0, false, false, true, false, false));
                support[0].weapons[0].projectile.AddBehavior(new CreateTowerModel("CreateTowerInAbility", GetTowerModel<SupportChinook>(), 0, false, false, true, false, false));
                support[0].weapons[0].projectile.AddBehavior(new CreateTowerModel("CreateTowerInAbility", GetTowerModel<ComancheDefense>(), 0, false, false, true, false, false));
        ...
        public class Middle5 : ModUpgrade<Marinetower>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                newsupport[0].weapons[0].projectile.AddBehavior(new CreateTowerModel("CreateTowerInAbility", GetTowerModel<ApachePrime>(), 0, false, false, true, false, false));
                newsupport[0].weapons[0].projectile.AddBehavior(new CreateTowerModel("CreateTowerInAbility", GetTowerModel<SpecialPoperations>(), 0, false, false, true, false, false));
                newsupport[0].weapons[0].projectile.AddBehavior(new CreateTowerModel("CreateTowerInAbility", GetTowerModel<ComancheCommander>(), 0, false, false, true, false, false));
        ...
        public class Bottom5 : ModUpgrade<Marinetower>
        {
            ...
            public override string Description => "No words can describe his strength...";
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                foreach (var weaponModel in towerModel.GetWeapons())
                {
                    ...
                    weaponModel.projectile.GetDamageModel().damage = 75;
                }
                ...
                Avatarspawner[0].weapons[0].projectile.AddBehavior(new CreateTowerModel("CreateTower", GetTowerModel<VengefulAvatar>(), 0, true, false, true, true, true));
