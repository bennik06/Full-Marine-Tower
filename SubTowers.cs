...
namespace marinetower
{
    internal class SubTowers
    {
        ...
        {
            //The code looks bad, because if the BaseTower is set to "TrueSunAvatarMini", the Avatar doesn't shoot until an actual Sun God is placed. When the BaseTower is set to "SuperMonkey-300", it plays the upgrade sound, every time the Marine places down an avatar! That's why I chose "DartMonkey".
